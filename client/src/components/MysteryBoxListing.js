    ...
    return (
      <div className="wrapper">
        ...
        <div className="std-colored-wrapper">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
            aliquam velit non lectus suscipit feugiat. Sed consectetur at lectus
            sed efficitur. Vestibulum quis est non lectus pretium congue in et
            dui. Proin sit amet metus at tortor efficitur porttitor quis et
            massa. Curabitur semper eros eget urna ornare pharetra.{" "}
          </p>
        </div>
      </div>
    );
