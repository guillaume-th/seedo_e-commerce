        ...
        return (
            <div>
                <form ref={userForm} onSubmit={submitUserData} encType="multipart/form-data">
                    ...
                    <input type="text" name="number_CB" placeholder="Numéro de carte bancaire" minLength={16} maxLength={16}></input>
                    <input type="text" name="cvv" placeholder="CVV" minLength={3} maxLength={3}></input>
                    <input type="text" name="expiration_CB" placeholder="Date d'expiration" minLength={5} maxLength={5}></input>
                ...
                <form ref={newAdressForm} onSubmit={addAdress} encType="multipart/form-data">
                    <input required type="text" name="number" placeholder="Numéro"></input>
                    <input required type="text" name="street" placeholder="Rue"></input>
                    <input required type="text" name="city" placeholder="Ville"></input>
                    <input required type="text" name="postal_code" placeholder="Code Postal"></input>
                    <input required type="text" name="country" placeholder="Pays"></input>
